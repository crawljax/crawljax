...
public class ClickableDetectorPlugin implements OnNewStatePlugin {
  ...
  public void onNewState(CrawlerContext context, StateVertex newState) {
    ...
    boolean isChrome = context.getConfig().getBrowserConfig().getBrowserType()
        == EmbeddedBrowser.BrowserType.CHROME ||
    ...
    if (isChrome && isUseCDP) {
      ...
      throw new IllegalStateException(
          "Cannot call ClickableDetector if the browser is not CHROME with CDP.\n" +
