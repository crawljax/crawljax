...
import static com.crawljax.vips_selenium.VipsUtils.*;

/**
 * Requirements:
 *      Chrome Browser
 *          - [BrowserConfiguration.BrowserType]
 *      Chrome Developer Tools enabled
 *          -  Default BrowserProvider : [BrowserOptions.setUSE_CDP(true)]
 *          -  Custom BrowserProvider : [WebDriverBackedEmbeddedBrowser.setUSE_CDP(true)]
 *
...
public class ClickableDetectorPlugin implements OnNewStatePlugin {
	...
	public void onNewState(CrawlerContext context, StateVertex newState) {
		...
		boolean isChrome = context.getConfig().getBrowserConfig().getBrowserType() == EmbeddedBrowser.BrowserType.CHROME ||
				context.getConfig().getBrowserConfig().getBrowserType()== EmbeddedBrowser.BrowserType.CHROME_HEADLESS;
