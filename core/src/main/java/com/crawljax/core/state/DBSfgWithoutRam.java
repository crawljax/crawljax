...
@Singleton
public class DBSfgWithoutRam implements Serializable, StateFlowGraph {
	...
	private static final Logger LOG = LoggerFactory.getLogger(DBSfgWithoutRam.class
	        .getName());
	 ...
	 */
	@Inject
	public DBSfgWithoutRam(ExitNotifier exitNotifier) {
		...
		DBSfgWithoutRam.structuralIndexer = indexNode;
	...
	public static void setIndexManager(IndexManager index) {
		DBSfgWithoutRam.indexManager = index;
	}
	...
	public static void setNodeIndex(Index<Node> nodeIndex) {
		DBSfgWithoutRam.nodeIndex = nodeIndex;
	}

	public static void setEdgesIndex(RelationshipIndex edgesIndex) {
		DBSfgWithoutRam.edgesIndex = edgesIndex;
	}
