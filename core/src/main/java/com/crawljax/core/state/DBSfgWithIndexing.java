...
@Singleton
public class DBSfgWithIndexing implements Serializable, StateFlowGraph {
	...
	private static final Logger LOG = LoggerFactory.getLogger(DBSfgWithIndexing.class
	        .getName());
	 ...
	 */
	@Inject
	public DBSfgWithIndexing(ExitNotifier exitNotifier) {
		...
		DBSfgWithIndexing.structuralIndexer = indexNode;
	...
	public static void setIndexManager(IndexManager index) {
		DBSfgWithIndexing.indexManager = index;
	}
	...
	public static void setNodeIndex(Index<Node> nodeIndex) {
		DBSfgWithIndexing.nodeIndex = nodeIndex;
	}

	public static void setEdgesIndex(RelationshipIndex edgesIndex) {
		DBSfgWithIndexing.edgesIndex = edgesIndex;
	}
