...
@Singleton
public class GraphDBStateFlowGraphNoRam implements Serializable, StateFlowGraph {
	...
	private static final Logger LOG = LoggerFactory.getLogger(GraphDBStateFlowGraphNoRam.class
	        .getName());
	 ...
	 */
	@Inject
	public GraphDBStateFlowGraphNoRam(ExitNotifier exitNotifier) {
		...
		GraphDBStateFlowGraphNoRam.structuralIndexer = indexNode;
	...
	private List<Eventable> neo4jPathToInMemoryPaht() {
	...
	public static void setSfgDb(GraphDatabaseService sfgDb) {
		GraphDBStateFlowGraphNoRam.sfgDb = sfgDb;
	}
	...
	public static void setIndexManager(IndexManager index) {
		GraphDBStateFlowGraphNoRam.indexManager = index;
	}
	...
	public static void setNodeIndex(Index<Node> nodeIndex) {
		GraphDBStateFlowGraphNoRam.nodeIndex = nodeIndex;
	}

	public static void setEdgesIndex(RelationshipIndex edgesIndex) {
		GraphDBStateFlowGraphNoRam.edgesIndex = edgesIndex;
	}
