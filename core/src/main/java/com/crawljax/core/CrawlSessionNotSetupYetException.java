...
/**
 * {@link CrawljaxException} that is thrown when you call {@link CrawlSessionProvider#get()} before
 * the the initial (index) {@link StateVertex} is crawled. Only after the index is crawled will the
