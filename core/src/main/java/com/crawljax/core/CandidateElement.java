...
public class CandidateElement {
    ...
    public CandidateElement(
            Element element, Identification identification, String relatedFrame, List<FormInput> formInputs) {
    ...
    public String getUniqueString() {
        ...
        if (element != null) {
            result += this.element.getNodeName() + ": " + DomUtils.getAllElementAttributes(this.element) + " ";
        }
