...
public class BrowserConfiguration {
    ...
    private static final Provider<EmbeddedBrowser> DEFAULT_BROWSER_BUILDER = new Provider<>() {
     ...
     * @param numberOfBrowsers The number of browsers you'd like to use. They will be started as soon
     *                         as the crawl starts.
     * @param browserOptions   Can specify parameters like pixel density for retina screens or
     *                         headless options for chrome
     */
    public BrowserConfiguration(BrowserType browserType, int numberOfBrowsers, BrowserOptions browserOptions) {
        this(browserType, numberOfBrowsers, DEFAULT_BROWSER_BUILDER);
     ...
     */
    public BrowserConfiguration(BrowserType browserType, int numberOfBrowsers, Provider<EmbeddedBrowser> builder) {
        Preconditions.checkArgument(numberOfBrowsers > 0, "Number of browsers should be 1 or more");
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(browserType, numberOfBrowsers, browserBuilder, remoteHubUrl, lang);
    }
