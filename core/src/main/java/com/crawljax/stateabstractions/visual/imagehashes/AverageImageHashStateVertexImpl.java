...
public class AverageImageHashStateVertexImpl extends StateVertexImpl {
    ...
    final AverageImageHash visHash;
     ...
     */
    @VisibleForTesting
    AverageImageHashStateVertexImpl(int id, String name, String dom, AverageImageHash visHash, Mat hashMat) {
     ...
     */
    public AverageImageHashStateVertexImpl(
            int id, String url, String name, String dom, String strippedDom, AverageImageHash visHash, Mat hashMat) {
    ...
    public boolean equals(Object object) {
        if (object instanceof AverageImageHashStateVertexImpl) {
            ...
            return (distance >= visHash.minThreshold && distance <= visHash.maxThreshold) || (distance == 0.0);
        }
        return false;
    }
