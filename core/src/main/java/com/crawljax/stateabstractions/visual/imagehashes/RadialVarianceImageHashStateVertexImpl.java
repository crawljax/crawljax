...
public class RadialVarianceImageHashStateVertexImpl extends StateVertexImpl {
	 ...
	 */
	@VisibleForTesting RadialVarianceImageHashStateVertexImpl(int id, String name, String dom, RadialVarianceImageHash visHash,
			Mat hashMat) {
	 ...
	 */
	public RadialVarianceImageHashStateVertexImpl(int id, String url, String name, String dom, String strippedDom,
			RadialVarianceImageHash visHash, Mat hashMat) {
	...
	public boolean equals(Object object) {
		if (object instanceof RadialVarianceImageHashStateVertexImpl) {
			RadialVarianceImageHashStateVertexImpl that = (RadialVarianceImageHashStateVertexImpl) object;
	...
	public boolean inThreshold(StateVertex vertexOfGraph) {
		...
		if (vertexOfGraph instanceof RadialVarianceImageHashStateVertexImpl) {
			RadialVarianceImageHashStateVertexImpl vertex = (RadialVarianceImageHashStateVertexImpl) vertexOfGraph;
