...
public class RadialVarianceImageHashStateVertexImpl extends StateVertexImpl {
   ...
   */
  @VisibleForTesting
  RadialVarianceImageHashStateVertexImpl(int id, String name, String dom,
      RadialVarianceImageHash visHash,
      Mat hashMat) {
   ...
   */
  public RadialVarianceImageHashStateVertexImpl(int id, String url, String name, String dom,
      String strippedDom,
