...
public class PerceptualImageDifferencing {
     ...
     */
    public PerceptualImageDifferencing(
            double fieldOfView,
            int thresholdPixels,
            boolean failFast,
            double gamma,
     ...
     */
    public void compare(ForkJoinPool pool, BufferedImage imgA, BufferedImage imgB, BufferedImage imgDiff) {
    ...
    public static class Builder {
        ...
        public PerceptualImageDifferencing build() {
            return new PerceptualImageDifferencing(
                    fieldOfView, thresholdPixels, failFast, gamma, luminance, luminanceOnly, colorFactor);
        }
    }
