...
public class ColorMomentImageHashStateVertexImpl extends StateVertexImpl {
	 ...
	 */
	@VisibleForTesting ColorMomentImageHashStateVertexImpl(int id, String name, String dom, ColorMomentImageHash visHash,
			Mat hashMat) {
	 ...
	 */
	public ColorMomentImageHashStateVertexImpl(int id, String url, String name, String dom, String strippedDom,
