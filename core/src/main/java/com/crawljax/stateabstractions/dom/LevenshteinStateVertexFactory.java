...
public class LevenshteinStateVertexFactory extends StateVertexFactory {
    ...
    public LevenshteinStateVertexFactory(double threshold) {
        ...
        this.editDistanceComparator = new EditDistanceComparator(LevenshteinStateVertexFactory.threshold);
    }
    ...
    public StateVertex newStateVertex(
        ...
        return new LevenshteinStateVertexImpl(id, url, name, dom, strippedDom, editDistanceComparator);
    }
