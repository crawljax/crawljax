...
//    saveImage(screenshot, screenShotFile, true);
  ...
  private List<DOMElementWithVisualInfo> getElementsVisualInfo(EmbeddedBrowser browser,
      String strippedDom) {
  ...
  private void populateDOMNodesWithVisualInfo(EmbeddedBrowser browser,
      List<DOMElementWithVisualInfo> domElements, Node node) {
  ...
  private BufferedImage getElementScreenshot(Rectangle boundingBox) {
    BufferedImage screenshotImage = screenshot.getSubimage(boundingBox.getX(), boundingBox.getY(),
