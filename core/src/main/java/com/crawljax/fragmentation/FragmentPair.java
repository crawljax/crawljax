...
public class FragmentPair {
  ...
  public boolean equals(Object obj) {
    if (obj instanceof FragmentPair) {
      ...
      try {
        if ((this.fragment1.equals(that.fragment1) && this.fragment2.equals(that.fragment2)
            && this.comparision == that.comparision)
            || (this.fragment1.equals(that.fragment2) && this.fragment2.equals(that.fragment1)
            && this.comparision == that.comparision)) {
          return true;
        }
      } catch (Exception ex) {
