...
public class HybridStateVertexImplTest {
  ...
  public StateVertex getStateNew(int id, String url, EmbeddedBrowser browser,
  ...
  public void testMDHFrag() throws InterruptedException {
    ...
    UtilsSelenium.click(driver, driver.findElement(By.xpath(
        "/html/body/div/div/div/app-root/gdpr-page/ibm-modal/ibm-overlay/section/div/ibm-modal-footer/footer/button[1]")));
