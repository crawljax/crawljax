...
public class UtilsSelenium {
  ...
  public static WebElement elementToBeClickable(WebDriver driver, WebElement webElement,
      int timeout) {
    try {
  ...
  public static WebElement elementTobeVisible(WebDriver driver, WebElement webElement,
      int timeout) {
    try {
      return getWebDriverFluentWait(driver, timeout)
