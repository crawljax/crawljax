...
//		driver.findElement(By.id("add_new_board")).click();
  ...
  public static StateVertex getState(int id, String url, FragmentManager manager,
      EmbeddedBrowser browser) throws InterruptedException {
    FragGenStateVertexFactory factory = new FragGenStateVertexFactory(0,
        CrawljaxConfiguration.builderFor(url), false);
  ...
  public static void mantisComp(String url, EmbeddedBrowser browser, FragmentManager manager)
  ...
  public static void compAddressbook(String url, EmbeddedBrowser browser, FragmentManager manager)
      throws InterruptedException {
...
//		manager.cacheStateComparision(state2, state1);
  ...
  private static void comp(String url, EmbeddedBrowser browser, FragmentManager manager)
      throws InterruptedException {
    WebDriver driver = browser.getWebDriver();
...
//		driver.findElement(By.xpath("//*[@id=\"new_board_form\"]/button")).click();
  ...
  public static void phoenix_opencard(WebDriver driver) {
    ...
    driver.findElement(By.xpath("/html/body/main/div/div/div/div/div/div/div/div[1]/div/div/div"))
        .click();
    waitAfterClick(1000);
  }
  ...
  public static void phoenix_addComment(WebDriver driver) {
    driver.findElement(By.xpath(
            "//*[@id=\"authentication_container\"]/div/div/div[2]/div/div/div[1]/div/form/div[2]/textarea"))
        .sendKeys("comment1");
    driver.findElement(
            By.xpath("/html/body/main/div/div/div/div/div[2]/div/div/div[1]/div/form/div[2]/button"))
        .click();
