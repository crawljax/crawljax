...
public class FragGenTests {
  ...
  public StateVertex getState(int id, URI url, EmbeddedBrowser browser,
    ...
    StateVertex state = factory.newStateVertex(id, browser.getCurrentUrl(), "state" + id,
  ...
  public void petclinicNDTests() throws URISyntaxException, InterruptedException {
    ...
    URI url2 = getUrl(
        "/replay/20230128041350/http://host.docker.internal:9966/petclinic/owners/10.html");
