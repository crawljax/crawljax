...
public class ConditionTest {
    ...
    /**
     * @param _self       We compare equivalence against self.
     * @param _equivalent This condition should be equivalent.
     * @param _different1 This one should be different -- typically different arguments
     * @param _different2 This one should be different -- same arguments, different constructor
     */
    public ConditionTest(Condition _self, Condition _equivalent, Condition _different1, Condition _different2) {
        this.self = _self;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            {new RegexCondition("rx0"), new RegexCondition("rx0"), new RegexCondition("rx1"), new UrlCondition("rx0")},
            {
            ...
            {new UrlCondition("u0"), new UrlCondition("u0"), new UrlCondition("u1"), new JavaScriptCondition("u0")},
            {
            ...
            {new XPathCondition("x0"), new XPathCondition("x0"), new XPathCondition("x1"), new JavaScriptCondition("x0")
            },
            {
            ...
            {
                new VisibleCondition(new Identification(Identification.How.xpath, "xp0")),
                new VisibleCondition(new Identification(Identification.How.xpath, "xp0")),
                new VisibleCondition(new Identification(Identification.How.tag, "xp0")),
                new VisibleCondition(new Identification(Identification.How.xpath, "xp1"))
            },
            {
                ...
                Logic.and(new VisibleCondition(new Identification(Identification.How.xpath, "xp")))
            },
            {
