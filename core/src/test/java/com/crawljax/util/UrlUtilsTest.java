...
public class UrlUtilsTest {
    ...
    public void getBaseUrl() {
        ...
        assertEquals("http://crawljax.com", UrlUtils.getBaseUrl("http://crawljax.com/about/history/"));

        assertEquals("http://crawljax.com", UrlUtils.getBaseUrl("http://crawljax.com/"));

        assertEquals("http://crawljax.com", UrlUtils.getBaseUrl("http://crawljax.com"));

        assertEquals("http://crawls.crawljax.com", UrlUtils.getBaseUrl("http://crawls.crawljax.com/demo"));

        assertEquals("http://crawls.crawljax.com", UrlUtils.getBaseUrl("http://crawls.crawljax.com"));
    }
    ...
    public void testExtractNewUrl() {
        ...
        assertThat(UrlUtils.extractNewUrl(base + "/example/b", "a"), is(URI.create(base + "/example/a")));

        assertThat(UrlUtils.extractNewUrl(base + "/example/b", "../a"), is(baseWithA));

        assertThat(UrlUtils.extractNewUrl(base, "http://test.example.com"), is(URI.create("http://test.example.com")));
    ...
    public void testIsSameDomain() {
        ...
        // Same URL
        assertThat(UrlUtils.isSameDomain("http://example.com", URI.create("http://example.com")), is(true));

        // Different URL
        assertThat(UrlUtils.isSameDomain("http://test.com", URI.create("http://example.com")), is(false));

        // Same URL with sub-domain
        assertThat(UrlUtils.isSameDomain("http://test.example.com", URI.create("http://example.com")), is(true));

        // Same URL but with HTTPS
        assertThat(UrlUtils.isSameDomain("https://example.com", URI.create("http://example.com")), is(true));

        // Same URL but with different fragment after #
        assertThat(
                UrlUtils.isSameDomain(
                        "https://example.com/#something=blah|somethingelse=blah1", URI.create("http://example.com")),
                is(true));
    }
}
