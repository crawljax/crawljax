...
public class BaseCrawler {
	...
	/**
	 * Starts the web server, configures Crawljax. Doesn't run the Crawler. For that
	 * you need to call {@link #crawl()}. After this method completes, you can
	 * configure the {@link CrawljaxConfiguration} and the
	 * {@link CrawljaxConfiguration} using {@link #newCrawlConfigurationBuilder()};
	 * <p>
	...
	/**
	 * Runs the crawler. If you haven't run {@link #setup()} it will do that before
	 * it runs.
	 *
	 * @return {@link CrawlSession} for post-crawl inspection.
	 * @throws CrawljaxException When crawljax isn't configured correctly or the web server fails
	 *                           to stop.
	 */
	 ...
	 *
	 * @param plugins The plugins you want to run with the
	...
	/**
	 * This starts the web server and blocks the thread so you can inspect the site
	 * in your browser manually. The URL to visit is printed to the console.
	 * <p>
	 * This thread will block once started so you have to stop it manually, once you
	 * are done.
	 *
