...
public class StateFlowGraphMatchers {
    ...
    public static FeatureMatcher<StateFlowGraph, Integer> hasEdges(int edges) {
        return new FeatureMatcher<StateFlowGraph, Integer>(
                equalTo(edges), "State-Flow Graph with number of edges", "number of edges") {
    ...
    public static FeatureMatcher<StateFlowGraph, Integer> hasStates(int states) {
        return new FeatureMatcher<StateFlowGraph, Integer>(
                equalTo(states), "State-Flow Graph with number of states", "number of states") {
    ...
    public static FeatureMatcher<StateVertex, String> stateWithDomSubstring(String substring) {
        return new FeatureMatcher<StateVertex, String>(
                containsString(substring), "StateVertex with in the DOM", "substring") {
