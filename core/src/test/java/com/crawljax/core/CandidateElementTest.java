...
public class CandidateElementTest {
    ...
    public void testEmptyElement() {
        Assert.assertEquals("General String and Unique String are the same", c.getGeneralString(), c.getUniqueString());
        Assert.assertEquals(
                "Expected result", "TEST:  xpath", c.getGeneralString().trim());
    }
    ...
    public void testOneAttributeElement() {
        ...
        Assert.assertEquals("General String and Unique String are the same", c.getGeneralString(), c.getUniqueString());
        Assert.assertEquals(
                "Expected result", "TEST: id=abc xpath", c.getGeneralString().trim());
    }
    ...
    public void testOneAttributeElementWithAtusa() {
        ...
        Assert.assertNotSame(
                "General String and Unique String are not the same", c.getGeneralString(), c.getUniqueString());
        Assert.assertEquals(
                "Expected result", "TEST: id=abc xpath", c.getGeneralString().trim());
        Assert.assertEquals(
                "Expected result",
                "TEST: atusa=ignore id=abc xpath",
                c.getUniqueString().trim());
    }
    ...
    public void testTwoAttributeElementWithAtusa() {
        ...
        Assert.assertEquals(
                "Expected result",
                "TEST: atusa=ignore class=def id=abc xpath",
                c.getUniqueString().trim());
    }
    ...
    public void testMultipleAttributeElementWithAtusaOrderedAlphabetical() {
        ...
        Assert.assertEquals(
                "Expected result",
                "TEST: a=a class=def id=abc x=a z=z xpath",
                c.getGeneralString().trim());
        Assert.assertEquals(
                "Expected result",
                "TEST: a=a atusa=ignore class=def id=abc x=a z=z xpath",
                c.getUniqueString().trim());
    }
}
