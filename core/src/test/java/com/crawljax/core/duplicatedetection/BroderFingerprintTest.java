...
public class BroderFingerprintTest {	
	...
	/**
	 * Test method for {@link com.crawljax.core.state.duplicatedetection.BroderFingerprint#getDistance(com.crawljax.core.state.duplicatedetection.Fingerprint)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link com.crawljax.core.state.duplicatedetection.BroderFingerprint#isNearDuplicateHash(com.crawljax.core.state.duplicatedetection.Fingerprint)}.
	 */
	@Test
	public void testIsNearDuplicateHash1() {		
		...
		assertThat(new BroderFingerprint(set1).getDistance(new BroderFingerprint(set2)), lessThan(0.8));
	}
	...
	public void testIsNearDuplicateHashFingerprintDoubleOnBoundary() {
		...
		boolean duplicate = new BroderFingerprint(set1).isNearDuplicateHash(new BroderFingerprint(set2), 0.8);
	...
	public void testIsNearDuplicateHashFingerprintDoubleOffBoundary() {
		...
		boolean duplicate = new BroderFingerprint(set1).isNearDuplicateHash(new BroderFingerprint(set2),2.0/6.0);
	...
	public void testIsNearDuplicateHashFingerprintOnBoundary() {
		...
		boolean duplicate = new BroderFingerprint(set1,0.8).isNearDuplicateHash(new BroderFingerprint(set2));
		assertTrue(duplicate);
	}
	...
	public void testIsNearDuplicateHashFingerprintOffBoundary() {
		...
		boolean duplicate = new BroderFingerprint(set1,2.0/6.0).isNearDuplicateHash(new BroderFingerprint(set2));
		assertFalse(duplicate);
	}
