...
public class GraphDBStateFlowGraphNoRamTest {
	...
	public void setup() {
		...
		// manual
		graph = new GraphDBStateFlowGraphNoRam(new ExitNotifier(0));
	...
	public void testGetMeanStateStringSize() {
		...
		// manual
		StateFlowGraph g = new GraphDBStateFlowGraphNoRam(new ExitNotifier(0));
