...
public class Neo4jBackedInMemoryPathFinderTest {
	...
	public void setup() {
		...
		// manual
		graph = new Neo4jBackedStateFlowGraphInMemoryPathFinder(new ExitNotifier(0));
	...
	public void testGetMeanStateStringSize() {
		...
		// manual
		StateFlowGraph g = new Neo4jBackedStateFlowGraphInMemoryPathFinder(new ExitNotifier(0));
