...
public class StateFlowGraphTest {
    ...
    @Before
    public void setup() {
        index = new StateVertexImpl(StateVertex.INDEX_ID, "index", "<table><div>index</div></table>");
    ...
    public void testDuplicationAdding() {
        ...
        assertTrue(state2.equals(new StateVertexImpl(2, "STATE_2", "<table><div>state2</div></table>")));
        ...
        StateVertex hold = new StateVertexImpl(StateVertex.INDEX_ID, index.getName(), index.getDom());
    ...
    public void testCloneStates() {
        StateVertex state3clone2 = new StateVertexImpl(3, "STATE_THREE", "<table><div>state2</div></table>");
