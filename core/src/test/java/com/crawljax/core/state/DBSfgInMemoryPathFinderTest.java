...
public class DBSfgInMemoryPathFinderTest {
	...
	public void setup() {
		...
		// manual
		graph = new DBSfgInMemoryPathFinder(new ExitNotifier(0));
	...
	public void testGetMeanStateStringSize() {
		...
		// manual
		StateFlowGraph g = new DBSfgInMemoryPathFinder(new ExitNotifier(0));
