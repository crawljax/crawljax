...
public class OracleTest {
    ...
    public void testDateOracle() {
        ...
        compareTwoDOMsWithComparatorEqual(
                "<HTML>Monday 15 march 1998</HTML>", "<HTML>Tuesday 13 december 2005</HTML>", oracle);
        compareTwoDOMsWithComparatorEqual(
        ...
        /* dates only numeric */
        compareTwoDOMsWithComparatorEqual("<HTML>28-12-1983</HTML>", "<HTML>15-3-1986</HTML>", oracle);
        ...
        compareTwoDOMsWithComparatorEqual("<HTML>19 november 1986</HTML>", "<HTML>18 june 1973</HTML>", oracle);
        compareTwoDOMsWithComparatorEqual("<HTML>1th march 1986</HTML>", "<HTML>28th december 2005</HTML>", oracle);
        compareTwoDOMsWithComparatorEqual("<HTML>15th november</HTML>", "<HTML>3th july</HTML>", oracle);

        compareTwoDOMsWithComparatorEqual("<HTML>2003 March 15</HTML>", "<HTML>1978 july 5</HTML>", oracle);
        compareTwoDOMsWithComparatorEqual("<HTML>2003Apr15</HTML>", "<HTML>1978jul5</HTML>", oracle);

        compareTwoDOMsWithComparatorEqual("<HTML>March 2003</HTML>", "<HTML>October 1996</HTML>", oracle);
        compareTwoDOMsWithComparatorEqual("<HTML>April '02</HTML>", "<HTML>August '99</HTML>", oracle);
        ...
        /* time */
        compareTwoDOMsWithComparatorEqual("<HTML>4:47:00 am</HTML>", "<HTML>3:59:2PM</HTML>", oracle);
    ...
    public void testStyleOracle() {
        ...
        compareTwoDOMsWithComparatorEqual(
                "<HTML><FONT color=\"red\">foo</FONT> bar</HTML>", "<HTML>foo bar</HTML>", oracle);
        compareTwoDOMsWithComparatorEqual(
                "<HTML><FONT color=\"red\">foo</FONT> bar</HTML>",
                "<HTML><FONT color=\"green\">foo</FONT> bar</HTML>",
                oracle);
        ...
        compareTwoDOMsWithComparatorEqual(
                "<HTML><SPAN>foo</SPAN></HTML>", "<HTML><SPAN valign=\"top\">foo</SPAN></HTML>", oracle);

        /* STYLE ATTRIBUTES */
        compareTwoDOMsWithComparatorEqual(
                "<HTML><SPAN style=\"color:  green;\">foo</SPAN></HTML>",
                "<HTML><SPAN style=\"color:red;\">foo</SPAN></HTML>",
                oracle);
        compareTwoDOMsWithComparatorEqual(
                "<HTML><SPAN style=\"color: yellow\">foo</SPAN></HTML>", "<HTML><SPAN>foo</SPAN></HTML>", oracle);
        compareTwoDOMsWithComparatorEqual(
                "<HTML><SPAN style=\"display:inline;color:red;\">foo</SPAN></HTML>",
                "<HTML><SPAN style=\"display:inline; color:green;\">foo</SPAN></HTML>",
                oracle);

        compareTwoDOMsWithComparatorNotEqual(
                "<HTML><SPAN style=\"display:inline;color:red;\">foo</SPAN></HTML>",
                "<HTML><SPAN style=\"display:none; color:green;\">foo</SPAN></HTML>",
                oracle);
    }
    ...
    public void testRegexOracle() {
        Comparator oracle = new RegexComparator("[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}");
        compareTwoDOMsWithComparatorEqual("<HTML>192.168.1.1</HTML>", "<HTML>10.0.0.138</HTML>", oracle);
    }
