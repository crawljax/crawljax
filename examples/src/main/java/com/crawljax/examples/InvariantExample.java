...
/**
 * Invariants are very useful in application testing. This example shows how to
 * create an {@link Invariant} that asserts that a certain string <b>never</b>
 * in any part of the website. Using the {@link OnInvariantViolationPlugin} we
 * can report the violation of this invariant.
 */
