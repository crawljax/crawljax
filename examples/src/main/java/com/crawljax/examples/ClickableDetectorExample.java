...
public class ClickableDetectorExample {
  ...
  public static void main(String[] args) {
    ...
    CrawljaxConfiguration.CrawljaxConfigurationBuilder builder = CrawljaxConfiguration.builderFor(
        appURL);
    ...
    builder.addPlugin(new TestSuiteGenerator(
        new TestConfiguration(TestConfiguration.StateEquivalenceAssertionMode.FRAG)));
