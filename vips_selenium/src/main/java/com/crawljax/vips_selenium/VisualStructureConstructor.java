...
public class VisualStructureConstructor {
    ...
    if (_visualStructure == null) {
      ...
      for (VisualStructure childVisualStructure : listStructures) {
        ...
        for (Separator separator : _horizontalSeparators) {
          ...
          separator.setRightDown(childVisualStructure.getX() + childVisualStructure.getWidth(),
              separator.endPoint);
        }
  ...
  private void constructVerticalVisualStructure() {
    ...
    if (_visualStructure == null) {
      ...
      for (Separator separator : _verticalSeparators) {
        ...
        separator.setRightDown(separator.endPoint,
            _visualStructure.getY() + _visualStructure.getHeight());
      }
      ...
      for (VisualStructure childVisualStructure : listStructures) {
        ...
        for (Separator separator : _verticalSeparators) {
          ...
          separator.setRightDown(separator.endPoint,
              childVisualStructure.getY() + childVisualStructure.getHeight());
        }
      ...
      if (actualStructure.getChildrenVisualStructures().size() == 0) {
        ...
        for (VisualStructure childVisualStructure : actualStructure.getChildrenVisualStructures()) {
          if (separator.startPoint >= childVisualStructure.getY() &&
              separator.endPoint <= (childVisualStructure.getY()
      ...
      if (actualStructure.getChildrenVisualStructures().size() == 0) {
        ...
        for (VisualStructure childVisualStructure : actualStructure.getChildrenVisualStructures()) {
          if (separator.startPoint >= childVisualStructure.getX() &&
              separator.endPoint <= (childVisualStructure.getX()
                  + childVisualStructure.getWidth())) {
            leftVisualStructure = new VisualStructure(driver);
            ...
            int width =
                (childVisualStructure.getWidth() + childVisualStructure.getX()) - separator.endPoint
                    - 1;
   ...
   */
  private void replaceBlocksInPredecessors(List<Node> oldBlocks, List<Node> newBlocks,
...
//				}
   ...
   * @param result          Results
   */
  private void findAllHorizontalSeparators(VisualStructure visualStructure,
    ...
    for (Separator separator : allSeparators) {
      ...
      for (Separator other : tempSeparators) {
        if (other.equals(separator)) {
          visualStructure.getHorizontalSeparators()
  ...
  public void normalizeSeparatorsMinMax() {
    ...
    for (Separator separator : separators) {
      double normalizedValue =
          (separator.weight - minWeight) / (maxWeight - minWeight) * (11 - 1) + 1;
