...
public class WivetTest {
    ...
    private static CrawlSpecification getCrawlSpec() {
        CrawlSpecification crawler = new CrawlSpecification("http://caos.uab.es/~gruiz/test/wivet/");
    ...
    private static CrawljaxConfiguration getConfig() {
        ...
        crawljaxConfiguration.setBrowser(EmbeddedBrowser.BrowserType.htmlunit);
