...
public class TestRecord {
    ...
    /**
     * @param testSrcPath the path to the test's generated source code
     */
    ...
    /**
     * @param testStatus the test status to set
     */
    ...
    /**
     * @param vertexName The name of the state vertex to which this diff corresponds to
