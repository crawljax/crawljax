...
public class ObjectDetection {
    ...
    /**
     * @param pageObjectFactory Factory which builds the desired {@code PageObject} type.
     * @param inputFile         Path to the screenshot of the web page to process.
     */
     ...
     * html
     *
     * @param alpha (gain/contrast) [1.0-3.0]
     * @param beta  (bias/brightness) [0-100]
     */
    ...
    private Mat drawContours(Mat adjusted, Mat image) {
        ...
        Imgproc.findContours(adjusted, contours, hierarchy, Imgproc.RETR_EXTERNAL, Imgproc.CHAIN_APPROX_SIMPLE);
