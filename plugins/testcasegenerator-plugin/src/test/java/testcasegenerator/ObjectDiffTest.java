...
public class ObjectDiffTest {
    ...
    public void testRoverDriver() {
        ...
        ObjectDetection srcDetection =
                new ObjectDetection(pageObjectFactory, "src/test/resources/mct-rover-weather.png");
        ObjectDetection dstDetection =
                new ObjectDetection(pageObjectFactory, "src/test/resources/mct-rover-weather_new.png");
    ...
    public void testHuaweiMobile() {
        ...
        /* Run the detection algorithm. */
        ObjectDetection srcDetection =
                new ObjectDetection(pageObjectFactory, "src/test/resources/huawei-mobile_old.png");
        ObjectDetection dstDetection =
                new ObjectDetection(pageObjectFactory, "src/test/resources/huawei-mobile_new.png");
