...
public class ClickableDetectorTest {
	...
	private CrawljaxConfigurationBuilder crawlDemoSetup() {
		return CrawljaxConfiguration.builderFor("http://www.ece.ubc.ca/~amesbah/")
		        .addPlugin(interceptor)
		        .setBrowserConfig(new BrowserConfiguration(EmbeddedBrowser.BrowserType.FIREFOX));
	}

	@Test
	public void clickableDetectorShouldFindSameStatesAsWithout() throws MalformedURLException,
