...
public class SiteRunnerCD {
	...
	public void before() {
		...
		startServer(Resource.newClassPathResource("sites"), "homepage");
	}
	...
	private CrawljaxConfigurationBuilder crawlDemoSetup() {
		...
		CrawljaxConfigurationBuilder conf =
		        CrawljaxConfiguration.builderFor(uri).addPlugin(interceptor).setBrowserConfig(
